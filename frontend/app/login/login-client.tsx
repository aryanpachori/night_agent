...
export function LoginClient({ telegramBotUsername }: { telegramBotUsername?: string }) {
  ...
  }, [onTelegramAuth, telegramBotUsername])
  ...
  const telegramBotConfigured = Boolean(telegramBotUsername)
